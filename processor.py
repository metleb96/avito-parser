...
class DataProcessor:
    ...
    def __init__(self, input_file: str = 'avito_data.csv', output_file: str = 'cleaned_avito_data.csv'):
        """
    ...
    def process(self) -> Dict[str, any]:
        ...
        logger.info(f"Начинаю обработку {self.input_file} -> {self.output_file}")
        try:
